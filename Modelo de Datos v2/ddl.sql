...
-- 5) bodas (10) (respeta FK a itinerarios)
...
-- 6) imagen_alergenos (10) (respeta FK a alergenos)
...
-- 7) imagen_productos (10) (respeta FK a productos)
...
-- 8) invitacion (10) (solo FK a bodas, como definiste)
INSERT INTO invitacion (id_usuario, id_boda, nombre, apellido_1, apellido_2, email, telefono, confirmado, acompanantes_mayores, acompanantes_menores) VALUES
...
-- 9) regalos (10) (solo FK a bodas, como definiste)
...
(9, 10, 'Hervidor práctico', 'https://shop.example.com/hervidor', NULL, 45.00, FALSE);

-- 10) usuarios_alergenos (10) (solo FK a usuarios, como definiste)
INSERT INTO usuarios_alergenos (id_usuario, id_alergeno, nombre) VALUES
(1, 1, 'Gluten'),
(1, 2, 'Lácteos'),
(2, 3, 'Frutos secos'),
(3, 2, 'Lácteos'),
...
-- 11) novios (10) (solo FK a bodas, como definiste)
...
(10, 10, 'Pablo','Vidal','Serrano','pablo.vidal@example.com','+34700011223');
